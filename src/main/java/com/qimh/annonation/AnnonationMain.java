...
public class AnnonationMain {
    ...
    public static void testInjectPerson() throws IntrospectionException, IllegalAccessException, InstantiationException, InvocationTargetException {
